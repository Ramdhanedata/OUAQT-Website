...
export const en: BuilderCopy = {
  ...
  code: {
    have: "I already have a configuration code",
    label: "Your configuration code",
    placeholder: "OUAQT-XXXX-XXXX",
    open: "Continue",
    opening: "One moment…",
    unknown: "Code not found. Check the characters, or ask for it to be sent again.",
    expired: "This code has expired. You can start the configuration again, or write to us on WhatsApp.",
    restart: "Start again",
    contact: "Write on WhatsApp",
    expiredMessage: "Hello, my configuration code has expired: {code}",
    wait: "Too many tries. Try again in {seconds} s.",
    failed: "The code could not be checked. Try again in a moment.",
    lost: "Lost your code?",
    lostIntro: "Type the phone number you gave during the configuration. The code will be sent to you again on WhatsApp.",
    lostPhone: "Phone number",
    lostSend: "Send",
    lostDone: "Noted. If this number was used for a configuration, you will receive the code on WhatsApp.",
    issuedHeading: "Your configuration code",
    issuedIntro: "It brings this configuration back on a computer. On the shop computer, open the OUAQT website, type this code, and everything you answered is there.",
    issuedSent: "It was also sent to you on WhatsApp.",
    issuedKeep: "Take a screenshot of this code, or write it on paper.",
    issuedPhone: "Your WhatsApp number, so this code can be sent to you again",
    issuedPhoneSave: "Save the number",
    issuedPhoneSaved: "Number saved.",
    issuedContinue: "Carry on here",
    issuedNotSerial: "This is not your serial number. You get that one when you download.",
    copy: "Copy",
    copied: "Copied",
    summaryHeading: "Your configuration",
    summaryIntro: "Check each line. Tap Edit to change anything that is wrong.",
    trade: "Business",
    ...
    productsLater: "You can also add your products later, in the software.",
  },
