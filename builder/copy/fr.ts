...
export const fr = {
  ...
  serial: {
    ...
    keepNumber: "Votre numéro de série. Gardez-le : il sert pour un deuxième poste, une réinstallation, ou si le logiciel vous le demande.",
    windowsWarning:
  ...
  install: {
    ...
    mac: "Mac",
    macHint: "iMac, MacBook ou Mac mini",
    ...
    winStep4: "L'icône de votre logiciel apparaît sur le bureau. Double-cliquez dessus.",
    ...
    lastTitle: "Votre logiciel s'ouvre",
    last: "Il s'ouvre directement sur votre commerce, prêt à vendre, et votre essai gratuit commence. Rien à taper.",
    ...
    artReady: "Prêt à vendre",
    artTrial: "Essai gratuit en cours",
  },
