...
export const fr = {
  ...
  code: {
    ...
    issuedIntro: "Il récupère cette configuration sur un ordinateur. Sur l'ordinateur du commerce, ouvrez le site OUAQT, tapez ce code, et vous retrouvez tout ce que vous avez répondu.",
    ...
    issuedContinue: "Continuer ici",
    issuedNotSerial: "Ce n'est pas votre numéro de série. Celui-là vous sera donné au moment du téléchargement.",
    copy: "Copier",
    copied: "Copié",
    summaryHeading: "Votre configuration",
    summaryIntro: "Vérifiez chaque ligne. Touchez Modifier pour changer ce qui ne va pas.",
    trade: "Activité",
    ...
    productsLater: "Vous pourrez aussi ajouter vos produits plus tard, dans le logiciel.",
  },
