...
const fr = {
  ...
  requests: {
    ...
    codesTitle: "Codes de configuration à renvoyer",
    codesIntro:
      "L'envoi sur WhatsApp n'est pas encore branché. Envoyez le code à la main avec le lien, puis marquez-le envoyé.",
    ...
    reviveTitle: "Réactiver un code expiré",
    reviveLabel: "Le code, tel que le propriétaire l'a envoyé",
    reviveFailed: "Code introuvable.",
...
const en: AdminCopy = {
  ...
  requests: {
    ...
    codesTitle: "Configuration codes to send again",
    codesIntro:
      "Sending on WhatsApp is not connected yet. Send the code by hand with the link, then mark it sent.",
    ...
    reviveTitle: "Revive an expired code",
    reviveLabel: "The code, as the owner sent it",
    reviveFailed: "Code not found.",
...
const ar: AdminCopy = {
  ...
  requests: {
    ...
    codesTitle: "رموز إعداد يجب إعادة إرسالها",
    codesIntro: "الإرسال على واتساب غير موصول بعد. أرسل الرمز يدويا عبر الرابط، ثم علمه كمرسل.",
    ...
    reviveTitle: "إعادة تفعيل رمز منتهي الصلاحية",
    reviveLabel: "الرمز كما أرسله صاحب المحل",
    reviveFailed: "لم نجد هذا الرمز.",
