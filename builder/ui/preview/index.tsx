...
const APP_WIDTH = 1280; // not-a-rule: the laptop screen the app is laid out for, in pixels
const APP_HEIGHT = 800; // not-a-rule: that screen's height, in pixels
const TITLE_HEIGHT = 36; // not-a-rule: the window's title bar, in pixels
